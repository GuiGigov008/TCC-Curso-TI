...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
      <a href="pages/login/acoes/logout.php" class="nav-link">Sair <i class="nav-icon fas fa-chevron-circle-right"></i></a>
    </li>
  </ul>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              ...
              <a href="pages/orcamento&venda/orcamento.php" class="nav-link">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item has-treeview">
              <a href="pages/cad_list_cliente.php" class="nav-link">
            ...
            <?php if ($adm == 1) : ?>
              <li class="nav-item has-treeview">
                <a href="pages/cad_list_func.php" class="nav-link">
              ...
              <li class="nav-item">
                <a href="pages/cad_list_fornecedor.php" class="nav-link">
                  <i class="fas fa-shapes nav-icon"></i>
                  <p>Fornecedores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/cad_list_pro.php" class="nav-link">
                  <i class="fas fa-folder-open nav-icon"></i>
                  <p>Produtos</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/cad_list_users.php" class="nav-link">
            ...
            <?php endif; ?>
            <li class="nav-item">
              <a href="pages/cad_list_veiculos.php" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/orcamento&venda/registro_orcamento_fechado.php" class="nav-link">
                    <i class="far fa-dot-circle nav-icon"></i>
                    <p>Fechados</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/orcamento&venda/registro_orcamento_aberto.php" class="nav-link">
