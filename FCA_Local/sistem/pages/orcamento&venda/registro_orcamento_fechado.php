...
<head>
  ...
  <title>Orçamentos | Fechados</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Orçamentos: <label style="color: green;">Fechados</label>
              <!-- <div style="background-color: limegreen; height: 20px; width: 20px; border-radius: 100%;"></div> -->
            </h1>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" width="10%">Vizualizar Orçamento</th>
                      <!-- Coluna de Atualizar <th width="5%">Atualizar</th> -->
                    </tr>
                  </thead>
                  ...
                  while ($dados = mysqli_fetch_array($busca)) {
                    ...
                    echo "
                      <tr>
                        ...
                        <td>
                        <center>
                          <a class='btn btn-success btn-sn' href='orcamento_feito_fechado.php?Numero_Orcamento=$id'>
                              <i class='fas fa-eye'>
                              </i>
                              Detalhes
                          </a>
                    ...
                    ";
                    //botão de atualizar
                    //<td>  <button type='submit' name='Enviar' value='Enviar' class='btn btn-outline-success btn-sn float-right'>Atualizar <span class='fas fa-check'></span></button></td>
                  }
