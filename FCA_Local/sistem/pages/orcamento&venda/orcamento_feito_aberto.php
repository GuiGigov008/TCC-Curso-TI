...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
      ...
      INNER JOIN clientes AS c ON c.Id_Cliente = o.fk_id_cliente INNER JOIN veiculos AS v ON v.Placa = o.Placa WHERE o.Numero_Orcamento = $id_orcamento";
        ...
        <div class='container-fluid'>
            ...
            <div class='col-12'>
              ...
              <div class='invoice p-3 mb-3'>
                ...
                <div class='row'>
                  <div class='col-12'>
                    <h4>
                      ...
                      <input name="Numero_Orcamento" value="<?php echo $id; ?>" hidden />
                    </h4>
                ...
                <div class='row invoice-info'>
                  ...
                  <!-- /.col -->
                  <div class='col-sm-3 invoice-col'>
                    <h4 style='font-weight: bold;'>Veículo <span class='fas fa-car-side'></span></h4>
                    <p>
          ...
          <div class="row no-print" style="margin-bottom: 2%;">
            <div class="col-12">
              <button type="submit" name="Enviar" value="Enviar" class="btn btn-success float-right"><i class="fas fa-check"></i> Fechar Ordem
              </button>
    ...
    if (isset($_POST["Enviar"])) {
      ...
      $id = mysqli_real_escape_string($link, $_POST['Numero_Orcamento']);
