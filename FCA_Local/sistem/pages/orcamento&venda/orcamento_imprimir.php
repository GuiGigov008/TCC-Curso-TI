...
$query = "SELECT o.*, c.CPF_CNPJ,c.Endereco_Cliente, c.Email_Cliente, c.Celular_Cliente, c.Telefone_Cliente, v.Marca FROM orcamento AS o
      INNER JOIN clientes AS c ON c.Id_Cliente = o.fk_id_cliente INNER JOIN veiculos AS v ON v.Placa = o.Placa WHERE o.Numero_Orcamento = $id";
...
if (mysqli_num_rows($result) > 0) {
  while ($linha = mysqli_fetch_array($result)) {
    ...
    $data_retorno = strtotime($data_retorno);
...
<body class="hold-transition sidebar-mini">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="page-header">
            <img src='../img\FCA_Logo.png' alt='FCA Logo' title='FCA - Fluxo de Caixa Automotivo' style='height: 100px; width: 100px;'> Orçamento | Pronto
            <small class="float-right">Data: <?php echo date('d/m/Y', $data_emissao); ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
  ...
  <div class='row'>
    ...
    <!-- /.col -->
    <div class='col-6'>
      <p class='lead'>Retorno: <?php echo date('d/m/Y', $data_retorno); ?></p>
